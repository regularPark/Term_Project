        ...
        while True:
            ...
            if n == 1:
                if len(product) == 0:
                    ...
                    for i in range(len(product)):
                        print('{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}'.format(product[i][0], product[i][1], product[i][2], product[i][3], product[i][4], product[i][5], product[i][6], product[i][7], product[i][8]))
                    print()
                product_manage()
            ...
            # Input
                ...
                if isOfCode == True and isArCode == True:
                    ...
                    if len(product) > 0:
                        for i in range(len(product)):
                            if product[i][0] == p_code:
                                print('Already exists. Input again.')
                                # todo while문 사용하여? 올바른 값 입력할때까지 반복.
