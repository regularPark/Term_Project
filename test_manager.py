...
def product_manage():
    if len(area) == 0:
        ...
        while True:
            ...
            if n == 1:
                print('-------------------------------------')
                print('Prod. code\tOfc. number\tArea number\tprod. type\tprod. name\tprod. price')
                for i in range(len(product)):
                    print('{}\t\t{}\t\t{}\t\t{}\t\t{}\t\t{}'.format(product[i][0], product[i][1], product[i][2], product[i][3], product[i][4], product[i][5]))
                print('\nLender\t\tLend date\tReturn date')
                for i in range(len(product)):
                    print('{}\t\t{}\t\t{}'.format(product[i][6], product[i][7], product[i][8]))
                product_manage()
            ...
            # Input
                ...
                product.append([p_code, off_num, ar_num, p_type, p_name, p_price , lender, len_date, ret_date])
                ...
                if len(product) == 0:
                    ...
                    while True:
                        ...
                        if num == 1:
                            ...
                            off_num, ar_num, isOfCode, isArCode = check_code()
                            for i in range(len(product)):
                                if product[i][1] == off_num and product[i][2] and isOfCode == True and isArCode == True:
                                    product[i][6] = input('Enter lender\'s name > ')
                                    product[i][7] = input('Enter lend date(must be 8 numbers) > ')                                    
